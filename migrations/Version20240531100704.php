 ...
 */
final class Version20240531100704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE grade CHANGE grade grade VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE grade CHANGE grade grade VARCHAR(255) NOT NULL');
